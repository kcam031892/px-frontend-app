...
const Statistics = () => {
  ...
  const [heightCmValue, setHeightCmValue] = useState(data ? data.data.attributes.statistics.height_cm : '');
  const [heightInValue, setHeightInValue] = useState('');
  const [waistSizeInValue, setWaistSizeInValue] = useState('');
  const [waistSizeCmValue, setWaistSizeCmValue] = useState('');
  const [weightKgValue, setWeightKgValue] = useState('');
  const [weightLbValue, setWeightLbValue] = useState('');
  const [collarCmValue, setCollarCmValue] = useState('');
  const [collarInValue, setCollarInValue] = useState('');
  const [insideLegCmValue, setInsideLegCmValue] = useState('');
  const [insideLegInValue, setInsideLegInValue] = useState('');
  const [outsideLegCmValue, setOutsideLegCmValue] = useState('');
  const [outsideLegInValue, setOutsideLegInValue] = useState('');
  const [hipCmValue, setHipCmValue] = useState('');
  const [hipInValue, setHipInValue] = useState('');
  const [hatCmValue, setHatCmValue] = useState('');
  const [hatInValue, setHatInValue] = useState('');
                ...
                <Grid xs={12} md={6} lg={6} item>
                  ...
                  <div className={classes.autocompleteContainer}>
                    <Autocomplete
                      ...
                      onChange={(e, newValue) => {
                        setEthnicityChipValue(newValue);
                        form.handleChange(e);
                      }}
                      renderTags={() => null}
                      renderInput={(params) => (
